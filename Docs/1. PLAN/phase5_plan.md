...
└── Plan/
    └── Phase5/
        ├── README.md                   # Phase 5 전반에 대한 문서
        ├── module_ci_cd.md             # CI/CD 모듈 설명
        ├── module_uiux.md              # UI/UX 모듈 설명
        ├── module_models.md            # Models 모듈 설명
        ├── module_signals.md           # Signals 모듈 설명
        ├── module_execution.md         # Execution 모듈 설명
        ├── module_indicators.md        # Indicators 모듈 설명
        └── module_data.md              # Data 모듈 설명
...
│   ├── arbitrage_features.py           # 아비트라지 피처 생성
